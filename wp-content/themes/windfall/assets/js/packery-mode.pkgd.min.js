...
! function(t, e) {
    ...
    return e.contains = function(t) {
        ...
        return this.y < e.y && (i = new t({
            ...
            width: this.width,
            height: e.y - this.y
        }), s.push(i)), r > n && (i = new t({
            x: n,
            y: this.y,
            width: r - n,
            height: this.height
        }), s.push(i)), h > o && (i = new t({
            x: this.x,
            y: o,
            width: this.width,
            height: h - o
...
function(t, e) {
    ...
    c.itemDragMove = function(t, e, i) {
        ...
        if (r) {
            ...
            var h = this,
                n = new Date;
            this._itemDragTime && n - this._itemDragTime < 120 ? (clearTimeout(this.dragTimeout), this.dragTimeout = setTimeout(s, 120)) : (s(), this._itemDragTime = n)
        }
    }, c.itemDragEnd = function(t) {
        function e() {
            2 == ++s && (i.element.classList.remove("is-positioning-post-drag"), i.hideDropPlaceholder(), r.dispatchEvent("dragItemPositioned", null, [i]))
        }
