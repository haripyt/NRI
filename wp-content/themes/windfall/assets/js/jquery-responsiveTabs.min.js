...
! function(a, b, c) {
    function e(b, c) {
        this.element = b, this.$element = a(b), this.tabs = [], this.state = "", this.rotateInterval = 0, this.$queue = a({}), this.options = a.extend({}, d, c), this.init()
    }
    var d = {
        active: null,
        disabled: [],
    ...
    e.prototype.init = function() {
        ...
        this.tabs = this._loadElements(), this._loadClasses(), this._loadEvents(), a(b).on("resize", function(a) {
            ...
            var e, d = c._getTabRefBySelector(b.location.hash);
            c._setState(a), c.options.startCollapsed === !0 || "accordion" === c.options.startCollapsed && "accordion" === c.state || (e = d >= 0 && !c._getTab(d).disabled ? c._getTab(d) : c.options.active > 0 && !c._getTab(c.options.active).disabled ? c._getTab(c.options.active) : c._getTab(0), c._openTab(a, e), c.options.load.call(this, a, e))
        }), this.$element.trigger("tabs-load")
    }, e.prototype._loadElements = function() {
        var b = this,
            c = this.$element.children("ul"),
            d = [],
            e = 0;
        return this.$element.addClass("r-tabs"), c.addClass("r-tabs-nav"), a("li", c).each(function() {
            var g, h, i, j, k, c = a(this),
                f = c.hasClass(b.options.classes.stateExcluded);
            if (!f) {
                g = a("a", c), k = g.attr("href"), h = a(k), i = a("<div></div>").insertBefore(h), j = a("<a></a>").attr("href", k).html(g.html()).appendTo(i);
                var l = {
                    _ignoreHashChange: !1,
                    id: e,
                    disabled: a.inArray(e, b.options.disabled) !== -1,
                    tab: a(this),
                    anchor: a("a", c),
                    panel: h,
                    selector: k,
        ...
        for (var a = this, c = function(c) {
                var d = a._getCurrentTab(),
                    e = c.data.tab;
                c.preventDefault(), e.disabled || (a.options.setHash && (b.location.hash = e.selector), c.data.tab._ignoreHashChange = !0, (d !== e || a._isCollapisble()) && (a._closeTab(c, d), d === e && a._isCollapisble() || a._openTab(c, e, !1, !0)))
            }, d = 0; d < this.tabs.length; d++) this.tabs[d].anchor.on("click", {
            tab: a.tabs[d]
        }, c), this.tabs[d].accordionAnchor.on("click", {
            tab: a.tabs[d]
        }, c)
    }, e.prototype._setState = function() {
        var b = a("ul", this.$element),
            c = this.state;
        b.is(":visible") ? this.state = "tabs" : this.state = "accordion", this.state !== c && this.$element.trigger("tabs-activate-state", {
            oldState: c,
            newState: this.state
        })
    }, e.prototype._openTab = function(a, b, c, d) {
        var e = this;
        c && this._closeTab(a, this._getCurrentTab()), d && this.rotateInterval > 0 && this.stopRotation(), b.active = !0, b.tab.removeClass(e.options.classes.stateDefault).addClass(e.options.classes.stateActive), b.accordionTab.removeClass(e.options.classes.stateDefault).addClass(e.options.classes.stateActive), e._doTransition(b.panel, e.options.animation, "open", function() {
            b.panel.removeClass(e.options.classes.stateDefault).addClass(e.options.classes.stateActive)
        }), this.$element.trigger("tabs-activate", b)
    }, e.prototype._closeTab = function(a, b) {
        var d = this;
    ...
    }, e.prototype._doTransition = function(a, b, c, d, e) {
        var f, g = this;
        switch (b) {
            case "slide":
    ...
    }, e.prototype._getTab = function(a) {
        return this.tabs[a]
    }, e.prototype._getTabRefBySelector = function(a) {
        for (var b = 0; b < this.tabs.length; b++)
            if (this.tabs[b].selector === a) return b;
        return -1
    }, e.prototype._getCurrentTab = function() {
        return this._getTab(this._getCurrentTabRef())
    }, e.prototype._getNextTabRef = function(a) {
        ...
        return -1
    }, e.prototype.activate = function(a, b) {
        ...
        return this.state
    }, e.prototype.startRotation = function(b) {
        var c = this;
        ...
        return b === c || "object" == typeof b ? this.each(function() {
            a.data(this, "responsivetabs") || a.data(this, "responsivetabs", new e(this, b))
        }) : "string" == typeof b && "_" !== b[0] && "init" !== b ? this.each(function() {
            var c = a.data(this, "responsivetabs");
            c instanceof e && "function" == typeof c[b] && c[b].apply(c, Array.prototype.slice.call(d, 1)), "destroy" === b && a.data(this, "responsivetabs", null)
        }) : void 0
    }
}(jQuery, window);