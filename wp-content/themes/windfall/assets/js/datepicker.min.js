...
! function(e, t) {
    ...
    function C(e) {
        return "date" === (t = e, a.call(t).slice(8, -1).toLowerCase()) && !w(e.getTime());
        var t
    }
    ...
    var V = /\d+/g,
        T = {
            ...
            parseDate: function(a) {
                var s = this.format,
                    e = [];
                return C(a) || (m(a) && (e = a.match(V) || []), C(a = a ? new Date(a) : new Date) || (a = new Date), e.length === s.parts.length && D.each(e, function(e, t) {
                    var i = parseInt(t, 10);
                    switch (s.parts[e]) {
                        case "dd":
                        case "d":
                        ...
                        case "yy":
                            ...
                            break;
                        case "yyyy":
                            a.setFullYear(2 === t.length ? 2e3 + i : i)
                    }
            ...
            formatDate: function(e) {
                ...
                if (C(e)) {
                    ...
                    i = t.source, D.each(t.parts, function(e, t) {
                        i = i.replace(t, r[t])
                    })
                }
                return i
                ...
                if (e.stopPropagation(), e.preventDefault(), !t.hasClass("disabled")) {
                    ...
                    switch (r) {
                        ...
                        case "year next":
                            ...
                            break;
                        case "year current":
                            n.hasYear && this.showView(v);
                            break;
                        case "year picked":
                            n.hasMonth ? this.showView(y) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("year");
                            break;
                        case "year":
                            h = parseInt(t.text(), 10), a.setFullYear(h), a.setDate(F(h, o, l)), s.setFullYear(h), s.setDate(F(h, o, l)), n.hasMonth ? this.showView(y) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("year");
                            break;
                        case "month prev":
                        case "month next":
                            ...
                            break;
                        case "month current":
                            n.hasMonth && this.showView(y);
                            break;
                        case "month picked":
                            n.hasDay ? this.showView(g) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("month");
                            break;
                        case "month":
                            o = D.inArray(t.text(), i.monthsShort), a.setFullYear(h), a.setDate(F(h, o, l)), a.setMonth(o), s.setFullYear(h), s.setDate(F(h, o, l)), s.setMonth(o), n.hasDay ? this.showView(g) : (t.addClass(i.pickedClass).siblings().removeClass(i.pickedClass), this.hideView()), this.pick("month");
                            break;
                        case "day prev":
                        case "day next":
                        case "day":
                            "day prev" === r ? o -= 1 : "day next" === r && (o += 1), l = parseInt(t.text(), 10), a.setFullYear(h), a.setMonth(o), a.setDate(l), s.setFullYear(h), s.setMonth(o), s.setDate(l), this.renderDays(), "day" === r && this.hideView(), this.pick("day");
                            break;
                        case "day picked":
        ...
        S = {
            ...
            renderDays: function() {
                ...
                for ((i = M.getDay() - parseInt(u, 10) % 7) <= 0 && (i += 7), n && (F = M.getTime() <= n.getTime()), t = e - (i - 1); t <= e; t += 1) {
                    var Y = new Date($, x, t),
                        V = !1;
                    n && (V = Y.getTime() < n.getTime()), !V && d && (V = !1 === d.call(a, Y, "day")), C.push(this.createItem({
                        disabled: V,
                        highlighted: $ === v && x === m && Y.getDate() === w,
                        muted: !0,
                        picked: $ === k && x === D && t === b,
                        text: t,
                        view: "day prev"
                ...
                var T = [],
                    ...
                    S = g,
                    P = !1;
                11 === g ? (I += 1, S = 0) : S += 1, e = G(f, g), i = 42 - (C.length + e);
                var N = new Date(f, g, e);
                for (r && (P = N.getTime() >= r.getTime()), t = 1; t <= i; t += 1) {
                    var j = new Date(I, S, t),
                        q = I === k && S === D && t === b,
                        A = !1;
                    r && (A = j.getTime() > r.getTime()), !A && d && (A = !1 === d.call(a, j, "day")), T.push(this.createItem({
                        disabled: A,
                        picked: q,
                        highlighted: I === v && S === m && j.getDate() === w,
                        muted: !0,
                        text: t,
                        view: "day next"
                    }))
                ...
                this.$monthPrev.toggleClass(l, F), this.$monthNext.toggleClass(l, P), this.$monthCurrent.toggleClass(l, F && P).html(s.yearFirst ? "".concat(f + p, " ").concat(c[g]) : "".concat(c[g], " ").concat(f).concat(p)), this.$days.html(C.join("") + O.join("") + T.join(""))
            }
        },
        P = "".concat(d, "-top-left"),
        N = "".concat(d, "-top-right"),
        j = "".concat(d, "-bottom-left"),
        q = "".concat(d, "-bottom-right"),
        A = [P, N, j, q].join(" "),
        O = function() {
            function i(e) {
                ...
                value: function() {
                    if (!this.inline) {
                        var e = this.$element,
                            ...
                            p = P;
                        w(u) && (u = 10), o < c && s < c + r + o ? (c -= o + u, p = j) : c += r + u, a < d + h && (d += n - h, p = p.replace("left", "right")), i.removeClass(A).addClass(p).css({
                            top: c,
                            left: d
                        })
                    }
    ...
    if (D.extend && D.extend(O.prototype, S, I, T), D.fn) {
        ...
        }, D.fn.datepicker.Constructor = O, D.fn.datepicker.languages = f, D.fn.datepicker.setDefaults = O.setDefaults, D.fn.datepicker.noConflict = function() {
